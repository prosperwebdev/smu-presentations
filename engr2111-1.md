...
<div class="grid place-items-center mt-8">
  <a href="https://www.linkedin.com/in/sheehanr/" class="justify-self-center group" target="_blank" rel="noopener noreferrer">
    <div>
      <h3 class="text-center group-hover:text-smu-secondaryBlue">LinkedIn</h3>
      <img src="/qr-ryan-sheehan.png" alt="LinkedIn for Ryan Sheehan" class="w-32"/>
    </div>
  </a>
</div>
